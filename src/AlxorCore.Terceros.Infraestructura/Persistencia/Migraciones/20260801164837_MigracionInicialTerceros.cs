...
{
    /// <inheritdoc />
    public partial class MigracionInicialTerceros : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(AlxorCore.Persistencia.RlsSql.Activar("terceros", "cliente"));
        }

        /// <inheritdoc />
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(AlxorCore.Persistencia.RlsSql.Desactivar("terceros", "cliente"));
