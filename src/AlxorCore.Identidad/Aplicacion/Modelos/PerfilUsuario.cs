...
public sealed record PerfilUsuario(Guid Id, string Email, string Nombre, bool EmailVerificado)
{
    public static PerfilUsuario Desde(Usuario usuario) =>
        new(usuario.Id, usuario.Email.Valor, usuario.Nombre, usuario.EmailVerificado);
}
